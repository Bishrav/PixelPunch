...
const Card = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <svg className="img" xmlns={Hero} xmlSpace="preserve" width="100%" height="100%" version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 784.37 1277.39" xmlnsXlink={Hero}>
          <g id="Layer_x0020_1">
        ...
        <div className="textBox">
          <p className="text head">Smart Shopping Made Simple</p>
          <span>Discover practical tips to help you shop smarter, save money, and choose the right products online.</span>
          <p className="text price">Read more</p>
        </div>
      </div>
    </StyledWrapper>
  );
